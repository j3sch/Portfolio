...
export default function ContactFields({ name }: props) {
	...
	return (
		<div>
			{clicked === true ? (
				<button className="bg-gray-400 bg-opacity-30 text-4xl rounded-lg w-full xl:w-[67.5rem] h-20 md:h-28 flex items-center text-center justify-center">
				...
				<div className="bg-gray-100 group rounded-lg w-full xl:w-[67.5rem] xl:mr-8 h-20 md:h-28 flex items-center text-center relative justify-center">
					<p className="text-center m-5 sm:m-12 md:m-14 self-center group-hover:hidden text-md sm:text-2xl md:text-3xl lg:text-4xl">
						{name}
					</p>
